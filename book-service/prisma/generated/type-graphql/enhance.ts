...
const resolversInfo = {
  Book: ["book", "findFirstBook", "books", "createBook", "deleteBook", "updateBook", "deleteManyBook", "updateManyBook", "upsertBook", "aggregateBook", "groupByBook"]
};
const modelsInfo = {
  Book: ["id", "name", "authorId"]
};
const inputsInfo = {
  BookWhereInput: ["AND", "OR", "NOT", "id", "name", "authorId"],
  BookOrderByWithRelationInput: ["id", "name", "authorId"],
  BookWhereUniqueInput: ["id"],
  BookOrderByWithAggregationInput: ["id", "name", "authorId", "_count", "_avg", "_max", "_min", "_sum"],
  BookScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "authorId"],
  BookCreateInput: ["name", "authorId"],
  BookUpdateInput: ["name", "authorId"],
  BookUpdateManyMutationInput: ["name", "authorId"],
  IntFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
  StringNullableFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "contains", "startsWith", "endsWith", "not"],
  BookCountOrderByAggregateInput: ["id", "name", "authorId"],
  BookAvgOrderByAggregateInput: ["id", "authorId"],
  BookMaxOrderByAggregateInput: ["id", "name", "authorId"],
  BookMinOrderByAggregateInput: ["id", "name", "authorId"],
...
const outputsInfo = {
  ...
  BookGroupBy: ["id", "name", "authorId", "_count", "_avg", "_sum", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  BookCountAggregate: ["id", "name", "authorId", "_all"],
  BookAvgAggregate: ["id", "authorId"],
  BookSumAggregate: ["id", "authorId"],
  BookMinAggregate: ["id", "name", "authorId"],
  BookMaxAggregate: ["id", "name", "authorId"]
};
const argsInfo = {
