...
const resolversInfo = {
  Author: ["author", "findFirstAuthor", "authors", "createAuthor", "deleteAuthor", "updateAuthor", "deleteManyAuthor", "updateManyAuthor", "upsertAuthor", "aggregateAuthor", "groupByAuthor"]
};
const modelsInfo = {
  Author: ["id", "name"]
};
const inputsInfo = {
  AuthorWhereInput: ["AND", "OR", "NOT", "id", "name"],
  AuthorOrderByWithRelationInput: ["id", "name"],
  AuthorWhereUniqueInput: ["id"],
  AuthorOrderByWithAggregationInput: ["id", "name", "_count", "_avg", "_max", "_min", "_sum"],
  AuthorScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name"],
  AuthorCreateInput: ["name"],
  AuthorUpdateInput: ["name"],
  AuthorUpdateManyMutationInput: ["name"],
  IntFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
  StringNullableFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "contains", "startsWith", "endsWith", "not"],
  AuthorCountOrderByAggregateInput: ["id", "name"],
  AuthorAvgOrderByAggregateInput: ["id"],
  AuthorMaxOrderByAggregateInput: ["id", "name"],
  AuthorMinOrderByAggregateInput: ["id", "name"],
...
const outputsInfo = {
  ...
  AuthorGroupBy: ["id", "name", "_count", "_avg", "_sum", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  AuthorCountAggregate: ["id", "name", "_all"],
  AuthorAvgAggregate: ["id"],
  AuthorSumAggregate: ["id"],
  AuthorMinAggregate: ["id", "name"],
  AuthorMaxAggregate: ["id", "name"]
};
const argsInfo = {
